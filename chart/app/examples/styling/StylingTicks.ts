  ...
  <Page>
    ...
    <RadCartesianChart>
      <RadCartesianChartGrid v-tkCartesianGrid
                              ...
                              horizontalStrokeColor="#8BC34A"
                              verticalStrokeColor="#8BC34A"
      ...
      <CategoricalAxis v-tkCartesianHorizontalAxis
                        verticalLocation="Bottom" lineThickness="1"
                        lineHidden="true" lineColor="#8BC34A"
                        labelLayoutMode="Outer" labelMargin="10"
                        labelTextColor="#536DFE" ticksHidden="false"
                        ticksLength="30" ticksThickness="3"
                        ticksColor="#536DFE" ticksOffset="-15">
      </CategoricalAxis>
      ...
      <LinearAxis v-tkCartesianVerticalAxis horizontalLocation="Right"
                  ...
                  labelFormat="%.2f" ticksHidden="false" ticksLength="30"
                  ticksThickness="3" ticksColor="#536DFE" ticksOffset="-15">
      </LinearAxis>
